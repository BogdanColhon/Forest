...
var geometry,geometry2, material,materialMars;
...
var mat;
var textureLoader,textureMars,displacementMap;
var textureURL = "https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/9b7029c3-9717-4658-9066-11c30aa24029/dcsauye-ba810e63-20e3-4ae9-a73c-9201ed87e67d.png/v1/fill/w_1280,h_640,q_80,strp/mars_texture_map__rare_version__by_oleg_pluton_dcsauye-fullview.jpg?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..X7rDRGm_uGFDxKyzB7nkfQuSxXmT87Hhg7CsW79lJTI";
var displacementURL = "https://static-2.gumroad.com/res/gumroad-public-storage/variants/bym0zdl8kio0llfyp4vdjjw5uvxk/baaca0eb0e33dc4f9d45910b8c86623f0144cea0fe0c2093c546d17d535752eb"; 
var done1=1;
var done2=1;
var done3=1;
var done4=1;
...
function init() {
    ...
    camera = new THREE.PerspectiveCamera(92, window.innerWidth / window.innerHeight, 1, 10000);
    camera.position.z = 5;
    ...
    geometry2 = new THREE.SphereGeometry( 1.7,190,190 );
    textureLoader = new THREE.TextureLoader();
    textureMars = textureLoader.load( textureURL );
    displacementMap = textureLoader.load( displacementURL );
    materialMars = new THREE.MeshPhongMaterial ( 
        { color: 0xffffff ,
            map: textureMars ,
    ...
    mars = new THREE.Mesh( geometry2, materialMars );
      mars.rotation.x = 3.1415*0.02;
      mars.rotation.y = 3.1415*1.54;
...
function UpdateScore() {
    ...
    document.getElementById("scoresMars").innerHTML = score + "km left";
...
function UpdateTopScore() {
    document.getElementById("topscoresMars").innerHTML = "Best:" + topScore + "km";
}
